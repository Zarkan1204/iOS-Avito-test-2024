...
class ResultsCollectionViewCell: UICollectionViewCell {
    ...
    private let nameLabel = UILabel(font: .boldSystemFont(ofSize: 12), textColor: .black)
    private let artistNameLabel = UILabel(font: .systemFont(ofSize: 12), textColor: .black)
    private let releaseDateLabel = UILabel(font: .systemFont(ofSize: 12), textColor: .lightGray)
